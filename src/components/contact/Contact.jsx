          ...
          <div className="contact__info">
            <div className="contact__card">
              ...
              <span className="contact__card-data">
                trishit456@gmail.com
              </span>

              <a
                href="mailto:trishit456@gmail.com"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">+91 6289615005</span>

              <a
                href="https://api.whatsapp.com/send?phone=6289615005&text=Hello, more information!"
                className="contact__button" target="_blank"
              >
                Write me{" "}
                <i className="bx bx-right-arrow-alt contact__button-icon"></i>
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">_trishit</span>
